...
exports.passThemes = void 0;
const colors_1 = require("./colors");
exports.passThemes = {
    // Purple brand pass - default skin
    purple: {
        gradientFrom: colors_1.colors.brand, // #7458FD
        gradientTo: '#9B7FFE',
        on: colors_1.colors.background, // #FFFFFF
    },
    ...
    university: {
        gradientFrom: colors_1.colors.backgroundNavy, // #011638
        gradientTo: '#1A3A5C',
        on: colors_1.colors.background, // #FFFFFF
    },
    ...
    cafe: {
        gradientFrom: '#0F9B63',
        gradientTo: colors_1.colors.success, // #16C172
        on: colors_1.colors.background, // #FFFFFF
    },
