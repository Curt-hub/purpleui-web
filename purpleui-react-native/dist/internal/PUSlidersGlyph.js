...
exports.PUSlidersGlyph = PUSlidersGlyph;
 ...
 */
function PUSlidersGlyph({ size = 18, color = '#7458FD' }) {
    const rowHeight = size / 3;
    const knobSize = Math.max(4, size * 0.3);
    const lineHeight = Math.max(1.5, size / 10);
    return (react_1.default.createElement(react_native_1.View, { style: { width: size, height: size } }, KNOB_OFFSETS.map((offset, i) => (react_1.default.createElement(react_native_1.View, { key: i, style: { height: rowHeight, justifyContent: 'center' } },
