    ...
    >
      ...
      >
        <path
          ...
          stroke={dark ? 'rgba(255,255,255,0.4)' : colors.onBackgroundTertiary}
          strokeWidth="2"
          strokeLinecap="round"
      ...
      <input
        ...
        className={dark ? 'placeholder:text-white/35' : 'placeholder:text-on-background-tertiary'}
        style={{
          flex: 1,
          ...
          fontSize: 16,
          fontWeight: 400,
          color: dark ? '#ffffff' : '#1a1a1a',  // no matching token — see report (closest is onBackground #000000, not an exact match)
          minWidth: 0,
        }}
      />
